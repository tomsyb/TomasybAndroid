...
public class IndexTable implements Serializable {
    ...
    public IndexTable(String newsChannelName) {
        this.newsChannelName = newsChannelName;
    }

    public IndexTable(String newsChannelName, String newsChannelId, String newsChannelType, boolean newsChannelSelect, int newsChannelIndex, Boolean newsChannelFixed) {
        this.newsChannelName = newsChannelName;
