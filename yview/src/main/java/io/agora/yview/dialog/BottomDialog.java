...
public class BottomDialog {
    ...
    private final class CustomDialog extends Dialog {
        ...
        private void init() {
            padding = getContext().getResources().getDimensionPixelSize(R.dimen.d10);
            topPadding = getContext().getResources().getDimensionPixelSize(R.dimen.d4);
            leftPadding = getContext().getResources().getDimensionPixelSize(R.dimen.d10);
            topIcon = getContext().getResources().getDimensionPixelSize(R.dimen.d38);
            leftIcon = getContext().getResources().getDimensionPixelSize(R.dimen.d32);
        ...
        private class DialogAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
            ...
            class TopHolder extends RecyclerView.ViewHolder {
                ...
                TopHolder(View view) {
                    ...
                    ViewGroup.LayoutParams params = new ViewGroup.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT);
                    params.width = getScreenWidth(getContext()) / 5;
                    ...
                    item.setTextSize(TypedValue.COMPLEX_UNIT_PX, getContext().getResources().getDimension(R.dimen.s10));
            ...
            class LeftHolder extends RecyclerView.ViewHolder {
                ...
                LeftHolder(View view) {
                    ...
                    item.setTextColor(ContextCompat.getColor(view.getContext(), R.color.b_main_black));
                    item.setTextSize(TypedValue.COMPLEX_UNIT_PX, getContext().getResources().getDimension(R.dimen.s14));
