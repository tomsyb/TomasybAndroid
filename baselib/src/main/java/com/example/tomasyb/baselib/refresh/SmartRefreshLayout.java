package com.example.tomasyb.baselib.refresh;
...
import com.example.tomasyb.baselib.refresh.api.DefaultRefreshFooterCreator;
...
import com.example.tomasyb.baselib.refresh.api.RefreshContent;
import com.example.tomasyb.baselib.refresh.api.RefreshFooter;
import com.example.tomasyb.baselib.refresh.api.RefreshHeader;
import com.example.tomasyb.baselib.refresh.api.RefreshInternal;
import com.example.tomasyb.baselib.refresh.api.RefreshKernel;
import com.example.tomasyb.baselib.refresh.api.RefreshLayout;
import com.example.tomasyb.baselib.refresh.api.ScrollBoundaryDecider;
import com.example.tomasyb.baselib.refresh.constant.DimensionStatus;
import com.example.tomasyb.baselib.refresh.constant.RefreshState;
import com.example.tomasyb.baselib.refresh.constant.SpinnerStyle;
import com.example.tomasyb.baselib.refresh.footer.BallPulseFooter;
import com.example.tomasyb.baselib.refresh.header.BezierRadarHeader;
import com.example.tomasyb.baselib.refresh.impl.RefreshContentWrapper;
...
import com.example.tomasyb.baselib.refresh.listener.OnLoadMoreListener;
import com.example.tomasyb.baselib.refresh.listener.OnMultiPurposeListener;
import com.example.tomasyb.baselib.refresh.listener.OnRefreshListener;
import com.example.tomasyb.baselib.refresh.listener.OnRefreshLoadMoreListener;
import com.example.tomasyb.baselib.refresh.listener.OnStateChangedListener;
import com.example.tomasyb.baselib.refresh.util.DelayedRunnable;
import com.example.tomasyb.baselib.refresh.util.DensityUtil;
import com.example.tomasyb.baselib.refresh.util.ViscousFluidInterpolator;
...
import static com.example.tomasyb.baselib.refresh.util.DensityUtil.dp2px;
import static com.example.tomasyb.baselib.refresh.util.SmartUtil.fling;
import static com.example.tomasyb.baselib.refresh.util.SmartUtil.getColor;
import static com.example.tomasyb.baselib.refresh.util.SmartUtil.isContentView;
...
//    }
     ...
     * Recommended {@link com.example.tomasyb.baselib.refresh.listener.SimpleMultiPurposeListener}
     * 设置多功能监听器
     * 建议使用 {@link com.example.tomasyb.baselib.refresh.listener.SimpleMultiPurposeListener}
     ...
     * Recommended {@link com.example.tomasyb.baselib.refresh.impl.ScrollBoundaryDeciderAdapter}
     * 设置滚动边界判断器
     * 建议使用 {@link com.example.tomasyb.baselib.refresh.impl.ScrollBoundaryDeciderAdapter}
