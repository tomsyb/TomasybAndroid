...
//    }
    ...
    /**
     * 设置多功能监听器
     * @param listener 建议使用 {@link com.example.tomasyb.baselib.refresh.listener.SimpleMultiPurposeListener}
     * @return SmartRefreshLayout
     */
    @Override
    ...
    /**
     * 设置滚动边界
     * @param boundary 建议使用 {@link com.example.tomasyb.baselib.refresh.impl.ScrollBoundaryDeciderAdapter}
     * @return SmartRefreshLayout
     */
    @Override
