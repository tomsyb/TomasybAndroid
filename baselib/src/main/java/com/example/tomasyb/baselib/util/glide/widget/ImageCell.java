package com.example.tomasyb.baselib.util.glide.widget;
...
import com.example.tomasyb.baselib.util.glide.progress.GlideApp;
import com.example.tomasyb.baselib.util.glide.util.Utils;
...
public class ImageCell extends ImageView {
    ...
    private class DrawableTarget extends DrawableImageViewTarget {
        ...
        private void setBackground() {
            if (radius == 0) {
                getView().setBackgroundResource(R.drawable.shap_stroke_gray_c0);
            } else if (radius == 5) {
                getView().setBackgroundResource(R.drawable.shap_stroke_gray_c5);
            } else {
                GradientDrawable drawable = (GradientDrawable) getResources().getDrawable(R.drawable.shap_stroke_gray_c0);
