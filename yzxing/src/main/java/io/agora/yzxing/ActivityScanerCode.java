...
import io.agora.yzxing.utils.RxAnimationTool;
import io.agora.yzxing.utils.RxBeepTool;
import io.agora.yzxing.utils.RxPhotoTool;
import io.agora.yzxing.utils.RxQrBarTool;
        ...
        if (resultCode == Activity.RESULT_OK) {
            ...
            try {
                ...
                if (rawResult != null) {
                    ...
                    if (mScanerListener == null) {
                        Toast.makeText(this,"图片识别失败",Toast.LENGTH_LONG).show();
                    } else {
