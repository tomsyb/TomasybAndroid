...
public class BottomBarTab extends FrameLayout {
    ...
    public void setSelected(boolean selected) {
        ...
        if (selected) {
            if (getTabPosition()==0){
                mIcon.setImageResource(R.drawable.tab_home_selected);
            }else if (getTabPosition()==1){
                mIcon.setImageResource(R.drawable.tab_book_selected);
            }else if (getTabPosition()==2){
                mIcon.setImageResource(R.drawable.tab_guide_selected);
            }else if (getTabPosition()==3){
                mIcon.setImageResource(R.drawable.tab_personal_selected);
            }
